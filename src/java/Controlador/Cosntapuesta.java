 ...
 * @author ealonso
 */
@WebServlet(name = "Cosntapuesta", urlPatterns = {"/Cosntapuesta"})
public class Cosntapuesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
          ...
          RequestDispatcher rd =request.getRequestDispatcher("Cosntapuesta.jsp");
