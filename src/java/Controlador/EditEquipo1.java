 ...
 * @author Dicita
 */
@WebServlet(name = "EditEquipo1", urlPatterns = {"/EditEquipo1"})
public class EditEquipo1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String $id= request.getParameter("id");
           ...
           RequestDispatcher rd =request.getRequestDispatcher("/UpdateEquipo1.jsp");
