 ...
 * @author Dicita
 */
@WebServlet(name = "EditEquipo2", urlPatterns = {"/EditEquipo2"})
public class EditEquipo2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
           ...
           Equipo2  equipo=equipo2Facade.find(id);                  
           request.setAttribute("equipo", equipo);
           
           List<TipoDeporte>  tipo=tipoDeporteFacade.findAll();
           request.setAttribute("tipo", tipo);
           
           RequestDispatcher rd =request.getRequestDispatcher("/UpdateEquipo2.jsp");
