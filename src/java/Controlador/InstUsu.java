 ...
 * @author ealonso
 */
@WebServlet(name = "InstUsu", urlPatterns = {"/InstUsu"})
public class InstUsu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            usuario.setNombUsu(nombre);
            usuario.setCedulUsu(cedula);
            usuario.setIdPerfiles(perfilesFacade.find(roll));
