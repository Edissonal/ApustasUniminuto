 ...
 * @author Dicita
 */
@WebServlet(name = "inserPartido", urlPatterns = {"/inserPartido"})
public class inserPartido extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
           ...
           RequestDispatcher rd =request.getRequestDispatcher("/inserPartido.jsp");
