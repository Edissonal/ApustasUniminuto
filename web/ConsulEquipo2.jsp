...
<html>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js" integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49" crossorigin="anonymous"></script>
    ...
    <body class="cover-container d-flex h-100 p-3 mx-auto flex-column">
        ...
        <p>
            <a href="inserEquipo2" class="btn btn-success">Agregar</a>
        </p>
            ...
            <thead>
                ...
                <tbody>
                    <c:forEach items="${equipo1}" var="dato">
                        <tr>
                            <td><c:out value="${dato.idEquipo2}" /> </td>
                            <td><c:out value="${dato.nombEquipo2}" /> </td>
                            <td><c:out value="${dato.idTipoDeporte.nombDepor}" /> </td>

                  <td><a href='<%= request.getContextPath()+"/EditEquipo2?id="%>${dato.idEquipo2}'>Editar</a></td>
                  <td><a href='<%= request.getContextPath()+"/DeletEquipo2?id="%>${dato.idEquipo2}'>Eliminar</a></td>
